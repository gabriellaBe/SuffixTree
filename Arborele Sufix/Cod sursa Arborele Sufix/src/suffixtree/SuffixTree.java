...
class SuffixTree
{
    ...
    public String dump_edges(int current_n )
    {
    	String result = "<html> Start  Sfr   Suf  Prim Idx  Ultim Idx  Text<br/><br/>";
        System.out.println(" Start  Sfr   Suf  Prim Idx  Ultim Idx  Text\n");
        for ( int j = 0 ; j < HASH_TABLE_SIZE ; j++ ) 
        {
            ...
            result += "&nbsp;&nbsp;&nbsp;&nbsp;" + s.start_node + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + s.end_node + "&nbsp;&nbsp;&nbsp;&nbsp;" + Nodes[ s.end_node ].suffix_node + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + s.first_char_index + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + s.last_char_index + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    ...
    public boolean checkIfSubtextExists(String subtext, int current_n){
    	for ( int j = 0 ; j < HASH_TABLE_SIZE ; j++ ) 
        {
            Edge s = Edges[j];
            if ( s.start_node == -1 )
